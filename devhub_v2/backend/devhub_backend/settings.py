...
# Load .env file - search current dir and up to 3 parent levels
try:
...
SECRET_KEY = 'django-insecure-h*ako3_h$2fws6=9ins$(-cv8^_*3g@-xsu&u7zes+e0m))_(c'
...
ASGI_APPLICATION = 'devhub_backend.asgi.application'
