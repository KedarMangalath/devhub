# Helpybo Module Custom Flow Codebase Reference

- Generated by DevHub: 2026-04-22T09:32:38.075394+00:00
- Documentation mode: `codebase_reference`
- Fingerprint: `c0c9fa553cc2732823b695d045b56d712c094a18`

## Overview

Helpybo Module Custom Flow is indexed from the live workspace and documented against fingerprint `c0c9fa553cc2732823b695d045b56d712c094a18`.
Detected runtime: static. Primary run command: `python -m http.server 4173 --bind 127.0.0.1`.
Indexed file count: 932.
...
### Evidence
- `helpybotest/helpybotest/urls.py`: High-signal file from the repository index.
- `helpybotest/accounts/urls.py`: High-signal file from the repository index.
- `helpybotest/manage.py`: High-signal file from the repository index.
- `helpybotest/static/js/main.js`: High-signal file from the repository index.
- `helpybotest/helpybotest/settings.py`: High-signal file from the repository index.
- `helpybotest/helpybotest/asgi.py`: High-signal file from the repository index.
...
### Evidence
- `helpybotest/helpybotest/urls.py`: Repository map ranked this file as high signal.
- `helpybotest/accounts/urls.py`: Repository map ranked this file as high signal.
- `helpybotest/manage.py`: Repository map ranked this file as high signal.
- `helpybotest/static/js/main.js`: Repository map ranked this file as high signal.
- `helpybotest/helpybotest/settings.py`: Repository map ranked this file as high signal.
- `helpybotest/helpybotest/asgi.py`: Repository map ranked this file as high signal.
- `helpybotest/helpybotest/wsgi.py`: Repository map ranked this file as high signal.
- `helpybotest/accounts/models.py`: Repository map ranked this file as high signal.
- `helpybotest/accounts/views.py`: Repository map ranked this file as high signal.
- `helpybotest/views.py`: Repository map ranked this file as high signal.
- `helpybotest/view1.py`: Repository map ranked this file as high signal.
- `helpybotest/media/sample_pages/user_11_sample.html`: Repository map ranked this file as high signal.
- `helpybotest/media/sample_pages/user_12_sample.html`: Repository map ranked this file as high signal.
- `helpybotest/media/sample_pages/user_13_sample.html`: Repository map ranked this file as high signal.
- `helpybotest/media/sample_pages/user_2_sample.html`: Repository map ranked this file as high signal.
- `helpybotest/media/sample_pages/user_4_sample.html`: Repository map ranked this file as high signal.
- `helpybotest/media/sample_pages/user_5_sample.html`: Repository map ranked this file as high signal.
- `helpybotest/media/sample_pages/user_6_sample.html`: Repository map ranked this file as high signal.
...
### Evidence
- `helpybotest/helpybotest/urls.py`: Represents the `helpybotest` area in the module catalog.
- `helpybotest/accounts/urls.py`: Represents the `helpybotest` area in the module catalog.
- `helpybotest/manage.py`: Represents the `helpybotest` area in the module catalog.
- `helpybotest/static/js/main.js`: Represents the `helpybotest` area in the module catalog.
- `helpybotest/helpybotest/settings.py`: Represents the `helpybotest` area in the module catalog.
- `helpybotest/helpybotest/asgi.py`: Represents the `helpybotest` area in the module catalog.
...
- `GET /`: Retrieve index.
- `POST /login/`: Create or submit login.
- `POST /register/`: Create or submit register.
- `GET /admin_dashboard/`: Retrieve admin dashboard.
- `GET /user_dashboard/`: Retrieve user dashboard.
- `POST /create_or_update_chatbot/`: Create or submit create or update chatbot.
- `POST /upload_pdf/`: Create or submit upload pdf.
- `POST /chat/response/<int:user_id>/`: Create or submit chat response.
- `GET /logout/`: Retrieve logout.
- `GET /chat_history/`: Retrieve chat history.
- `GET /chat_history/<str:session_id>/`: Retrieve chat history.
- `GET /preview_chatbot/`: Retrieve preview chatbot.
- `POST /delete_pdf/<int:pdf_id>/`: Create or submit delete pdf.
- `POST /update_webapp_info/`: Create or submit update webapp info.
- `GET /regenerate_widget/`: Retrieve regenerate widget.
- `POST /customize_chatbot/`: Create or submit customize chatbot.
- `POST /update_custom_rules/`: Create or submit update custom rules.
- `POST /userregister/`: Create or submit userregister.
- `POST /delete_user/<int:user_id>/`: Create or submit delete user.
- `POST /delete_vectorstore/`: Create or submit delete vectorstore.
- `GET /refresh_vectorstore/`: Retrieve refresh vectorstore.
- `POST /delete_logo/`: Create or submit delete logo.
- `POST /delete_we_are_here_image/`: Create or submit delete we are here image.
- `POST /update-api-key/<int:user_id>/`: Create or submit update api key.
- `GET /toggle-translation/<int:user_id>/`: Retrieve toggle translation.
- `POST /update-whatsapp-license/<int:user_id>/`: Create or submit update whatsapp license.
- `POST /update-whatsapp-api-key/<int:user_id>/`: Create or submit update whatsapp api key.
- `POST /update-telegram-token/<int:user_id>/`: Create or submit update telegram token.
- `GET /whatsapp/<int:user_id>/`: Retrieve whatsapp.
- `GET /telegram/<int:user_id>/`: Retrieve telegram.
- `GET /test/<int:user_id>/`: Retrieve test.
- `GET /leads/`: Retrieve leads.
- `POST /save-lead/<int:chatbot_id>/`: Create or submit save lead.
- `GET /toggle-leads/<int:user_id>/`: Retrieve toggle leads.
- `POST /delete_chat_toggle_image/`: Create or submit delete chat toggle image.
- `GET /generate_summary/<str:session_id>/`: Retrieve generate summary.
- `GET /delete-lead/<int:lead_id>/`: Retrieve delete lead.
- `POST /add_category/`: Create or submit add category.
- `POST /add_product/`: Create or submit add product.
- `GET /view_products/`: Retrieve view products.
- `GET /download_products_pdf/`: Retrieve download products pdf.
- `POST /update-whatsapp-appkey/<int:user_id>/`: Create or submit update whatsapp appkey.
- `POST /update-whatsapp-authkey/<int:user_id>/`: Create or submit update whatsapp authkey.
- `GET /custom-flow/`: Single page for managing custom chat flows
- `POST /api/flow/create/`: API endpoint to create a new flow
- `POST /api/flow/<int:flow_id>/update/`: API endpoint to update a flow
- `POST /api/flow/<int:flow_id>/delete/`: API endpoint to delete a flow
- `POST /api/flow/<int:flow_id>/step/add/`: API endpoint to add a step to a flow
- `GET /api/flow/<int:flow_id>/step/<int:step_id>/update/`: API endpoint to update a step or get step data
- `POST /api/flow/<int:flow_id>/step/<int:step_id>/update/`: API endpoint to update a step or get step data
- `POST /api/flow/<int:flow_id>/step/<int:step_id>/delete/`: API endpoint to delete a step
- `POST /api/flow/<int:flow_id>/steps/reorder/`: API endpoint to reorder steps
- `GET /api/get-flow/<int:flow_id>/`: Get full flow data including steps and buttons
- `GET /api/get-active-flow/<int:chatbot_id>/`: Get the active flow for a specific chatbot
- `GET /accounts/login/`: Retrieve accounts login.
...
### Evidence
- `helpybotest/helpybotest/urls.py`: Detected as an API, routing, or view-related file.
- `helpybotest/accounts/urls.py`: Detected as an API, routing, or view-related file.
- `helpybotest/accounts/views.py`: Detected as an API, routing, or view-related file.
- `helpybotest/views.py`: Detected as an API, routing, or view-related file.
- `helpybotest/view1.py`: Detected as an API, routing, or view-related file.
- `helpybotest/templates/preview_chatbot.html`: Detected as an API, routing, or view-related file.
- `helpybotest/templates/view_products.html`: Detected as an API, routing, or view-related file.
- `helpybotest/accounts/views.py`: Implements routed handler `index`.
- `helpybotest/accounts/views.py`: Implements routed handler `login_view`.
- `helpybotest/accounts/views.py`: Implements routed handler `register`.
- `helpybotest/accounts/views.py`: Implements routed handler `admin_dashboard`.
- `helpybotest/accounts/views.py`: Implements routed handler `user_dashboard`.
- `helpybotest/accounts/views.py`: Implements routed handler `create_or_update_chatbot`.
- `helpybotest/accounts/views.py`: Implements routed handler `upload_pdf`.
...
### Evidence
- `helpybotest/accounts/models.py`: Detected as a model, schema, or typed data file.
...
Source repository: https://github.com/gaudesolutions/helpybo_module_custom_flow

### Evidence
- `helpybotest/manage.py`: Detected as setup, runtime, or configuration evidence.
