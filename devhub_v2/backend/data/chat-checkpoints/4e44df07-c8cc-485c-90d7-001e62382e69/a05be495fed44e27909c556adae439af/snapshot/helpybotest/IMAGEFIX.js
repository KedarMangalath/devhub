(function() {
    ...
    function sendMessage() {
        ...
        if (isFirstMessage && !leadState.nameCollected && leadsEnabled) { // Add leadsEnabled check here
        ...
        if (leadState.nameCollected && !leadState.phoneCollected && leadsEnabled) { // Add leadsEnabled check here
