(function() {
    ...
    width: 460px;
    height: 80%;
    {% comment %} border: 5px solid #7faffb42; {% endcomment %}
    border-radius: 35px;
    background: #fff;
...
.bot-message:before {
    ...
    bottom: 0;
    left: 0;
        background: linear-gradient(-45deg, {{ header_color }} 0%, {{ header_color }} 100%);
...
.bot-message::after {
    ...
    z-index: 10;
        ...
        #chat-button:before {
            ...
            bottom: 0;
            left: 0;
            background: linear-gradient(-45deg, {{ header_color }} 0%, #ffffff 100%);
...
.quick-link:hover:before {
  top: -70%;
  background-image: radial-gradient(circle, {{ header_color }}; 20%, transparent 20%),
    radial-gradient(circle, transparent 20%, {{ header_color }}; 20%, transparent 30%),
    radial-gradient(circle, {{ header_color }}; 20%, transparent 20%),
    radial-gradient(circle, {{ header_color }}; 20%, transparent 20%),
    radial-gradient(circle, transparent 10%, {{ header_color }}; 15%, transparent 20%),
    radial-gradient(circle, {{ header_color }}; 20%, transparent 20%),
    radial-gradient(circle, {{ header_color }}; 20%, transparent 20%),
    radial-gradient(circle, {{ header_color }}; 20%, transparent 20%),
    radial-gradient(circle, {{ header_color }}; 20%, transparent 20%);
...
.quick-access-button {
    ...
    border: 0.5px solid {{ header_color }};
...
.quick-access-button:hover {
  background-color: {{ header_color }};
  box-shadow: 0 0 0 2px {{ header_color }};
  color: #fff;
}
...
width:100%;
  height: 100%;
  border-radius: 55px;
  background: linear-gradient(135deg, {{ header_color }}, {{ header_color }});
...
.option-button {
  ...
  box-shadow: 2px 2px 7px rgba(108, 117, 125, 0.56);
    ...
    let leadsEnabled = {{ leads_enabled|lower }};
    ...
    function initChatWidget() {
        ...
        const chatToggleUrl = '{{ chat_toggle_image_url }}';
  ...
  <path
    ...
    style="stroke: none; fill: {{ header_color }};"
  ></path>
</svg>
...
<div class="parent">
        <div class="card">
            <div class="logo">
                ...
                <span class="circle circle5">
                    <img src="${'{{ logo_url }}' || '#'}" alt="Chatbot Logo" height="35">
                </span>

            </div>
            <div class="glass"></div>
            <div class="content">
                <span class="title">{{ header_text }}</span>
                <span class="text">{{ business_info }}</span>
            </div>
            <div class="bottom">
  ...
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
            ...
            <div id="help-page" class="page">
                ...
                <div class="help-section">
                    <h3>FAQs</h3>
                    <p><strong>{{ faq|safe }}</strong></p>
                </div>
            </div>
            <div id="chat-footer">
                <ul class="footer-button">
        <li style="--i:{{ header_color }};--j:{{ header_color }};" onclick="window.navigateToPage('home')">
  ...
  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5"/>
    ...
    <ul class="footer-button">
        <li style="--i:{{ header_color }};--j:{{ header_color }};" onclick="window.navigateToPage('chat')">
  ...
  <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.5a1 1 0 0 0-.8.4l-1.9 2.533a1 1 0 0 1-1.6 0L5.3 12.4a1 1 0 0 0-.8-.4H2a2 2 0 0 1-2-2zm5 4a1 1 0 1 0-2 0 1 1 0 0 0 2 0m4 0a1 1 0 1 0-2 0 1 1 0 0 0 2 0m3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
    ...
    <ul class="footer-button">
        <li style="--i:{{ header_color }};--j:{{ header_color }};" onclick="window.navigateToPage('help')">
  ...
  <path d="M5.933.87a2.89 2.89 0 0 1 4.134 0l.622.638.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.636a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.011a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01zM7.002 11a1 1 0 1 0 2 0 1 1 0 0 0-2 0m1.602-2.027c.04-.534.198-.815.846-1.26.674-.475 1.05-1.09 1.05-1.986 0-1.325-.92-2.227-2.262-2.227-1.02 0-1.792.492-2.1 1.29A1.7 1.7 0 0 0 6 5.48c0 .393.203.64.545.64.272 0 .455-.147.564-.51.158-.592.525-.915 1.074-.915.61 0 1.03.446 1.03 1.084 0 .563-.208.885-.822 1.325-.619.433-.926.914-.926 1.64v.111c0 .428.208.745.585.745.336 0 .504-.24.554-.627"/>
    ...
    function toggleChat() {
        ...
        if (chatWidget.style.display === 'none' || chatWidget.style.display === '') {
            ...
            appendMessage("{{ welcome_message }}", 'bot-message');
    ...
    async function appendMessage(content, className, isHTML = false) {
        const chatMessages = document.getElementById('chat-messages');
        ...
        // If content is to be rendered as raw HTML
        if (isHTML) {
            messageDiv.innerHTML = content;
        } else {
            // For the very first bot message, display welcome messages and options
            if (className === 'bot-message' && isFirstMessage) {
                ...
                secondMessage.classList.add('message', 'bot-message');
                secondMessage.innerHTML = `
                    <p>Welcome to our website. I am here to help you.</p>
                    <div class="timestamp">${getCurrentTime()}</div>
                `;
                chatMessages.appendChild(secondMessage);
    
                // Third message with luxury home size options
                const thirdMessage = document.createElement('div');
                thirdMessage.classList.add('message', 'bot-message');
                thirdMessage.innerHTML = `
                    <p>Which luxury home size interests you?</p>
                    <div class="button-container">
                        <button class="option-button" data-option="2 BHK with deck">2 BHK with deck</button>
                        <button class="option-button" data-option="3 BHK with deck">3 BHK with deck</button>
                        <button class="option-button" data-option="4 BHK with deck">4 BHK with deck</button>
                        <button class="option-button" data-option="5 BHK with deck">5 BHK with deck</button>
                    </div>
                    <div class="timestamp">${getCurrentTime()}</div>
                `;
                chatMessages.appendChild(thirdMessage);
    
                // Add event listeners to these option buttons
            ...
            // For regular messages, split the content by newline and create <p> elements
    ...
    function handleOptionClick(selectedOption) {
        // Append the user's selected option as a message

        userSelections.propertyType = selectedOption;
        ...
        // Check if lead activation logic should be triggered
        ...
        // Create a paragraph for the budget range question
        const budgetQuestion = document.createElement('p');
        budgetQuestion.textContent = "What is your budget range?";
        budgetQuestion.style.marginBottom = '10px';
        
        // Create a container for budget options
        const budgetOptionsContainer = document.createElement('div');
        budgetOptionsContainer.classList.add('button-container');
        
        // Define the budget options
        const budgetOptions = [
            { label: '    3 Cr -     5 Cr', value: '    3 Cr -     5 Cr' },
            { label: '    5 Cr -     7 Cr', value: '    5 Cr -     7 Cr' },
            { label: '    7 Cr -     17 Cr', value: '    7 Cr -     17 Cr' },
            { label: '    17 Cr and above', value: '    17 Cr and above' }
        ];
        
        // Create buttons for each budget option
        budgetOptions.forEach(option => {
            ...
            button.addEventListener('click', function() {
                const selectedBudget = button.getAttribute('data-option');
                handleBudgetSelection(selectedBudget);
            });
            budgetOptionsContainer.appendChild(button);
        });
        
        // Create a message container for the budget question and options
        const messageContainer = document.createElement('div');
        messageContainer.classList.add('message', 'bot-message');
        messageContainer.appendChild(budgetQuestion);
        messageContainer.appendChild(budgetOptionsContainer);
        
        // Append the container to the chat messages and scroll down
        const chatMessages = document.getElementById('chat-messages');
        chatMessages.appendChild(messageContainer);
        chatMessages.scrollTop = chatMessages.scrollHeight;
    }
    
    function handleBudgetSelection(selectedBudget) {
        // Append the user's selected budget as a message

        userSelections.budgetRange = selectedBudget;

        appendMessage(selectedBudget, 'user-message');
        ...
        // Define the bot response based on the selected budget range
        let botResponse;
        switch (selectedBudget) {
            case '    3 Cr -     5 Cr':
                botResponse = "Our 2 BHK option (772 sq.ft.) is suitable for your budget range of     3 Cr -     5 Cr. One Meraki is centrally located in Chembur with seamless connectivity to business hubs, top schools, and entertainment zones.";
                break;
            case '    5 Cr -     7 Cr':
                botResponse = "Our 3 BHK option (1221 sq.ft.) is suitable for your budget range of     5 Cr -     7 Cr. One Meraki is centrally located in Chembur with seamless connectivity to business hubs, top schools, and entertainment zones.";
                break;
            case '    7 Cr -     17 Cr':
                botResponse = "Our 4 BHK option (1993 sq.ft.) is suitable for your budget range of     7 Cr -     17 Cr. One Meraki is centrally located in Chembur with seamless connectivity to business hubs, top schools, and entertainment zones.";
                break;
            case '    17 Cr and above':
                botResponse = "Our Premium 4 BHK option (3850 sq.ft.) is suitable for your budget range. One Meraki is centrally located in Chembur with seamless connectivity to business hubs, top schools, and entertainment zones.";
                break;
            default:
                botResponse = "Please select a valid budget range.";
        }
        
        // Append the bot's response
        appendMessage(botResponse, 'bot-message');
        
        // Ask if the user would like to see the brochure
        appendMessage("Would you like to see our brochure?", 'bot-message');
        
        // Define the brochure options as an HTML string
        ...
        `;
        // Append the brochure options using the isHTML flag
        appendMessage(brochureOptions, 'bot-message', true);
        
        // Attach event listeners to the newly added brochure buttons
        const brochureButtons = document.querySelectorAll('.button-container .option-button');
        brochureButtons.forEach(button => {
            button.addEventListener('click', function() {
                const selectedBrochureOption = button.getAttribute('data-option');
                handleBrochureSelection(selectedBrochureOption);
            });
        });
    }
    
    function handleBrochureSelection(selectedBrochureOption) {
        // Append the user's selection
        appendMessage(selectedBrochureOption, 'user-message');
        ...
        if (selectedBrochureOption === "Yes") {
            // First ask for the user's name
            appendMessage("Please share your name to receive the brochure.", 'bot-message');
            
            // Set a flag to indicate we're waiting for name input
            window.awaitingName = true;
        } else {
            // End the conversation or provide another prompt
            appendMessage("Thank you for your interest! If you have any more questions, feel free to ask.", 'bot-message');
        }
    }
    ...
    function updateInputState() {
        ...
        if (leadsEnabled && (!leadState.nameCollected || !leadState.phoneCollected)) {
            ...
            messageInput.placeholder = 'Please provide contact information first...';
        } else {
    ...
    function saveLead() {
        ...
        const leadData = {
            ...
            session_id: sessionId,
            property_selection: userSelections.propertyType,
            budget_range: userSelections.budgetRange
        };
    
        console.log('Saving lead with data:', leadData);  // Debug log
    
        // Get base URL from chat response URL
        const chatResponseUrl = '{{ chat_response_url }}';
