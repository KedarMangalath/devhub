        ...
        chatWidget.innerHTML = `
            <div id="chat-header">
                <div class="header-text-container">
                    <img id="chat-logo" src="${'http://127.0.0.1:7000/media/chatbot_logos/calmove.PNG' || '#'}" alt="Chatbot Logo">
        ...
        <div class="card">
            <div class="logo">
                ...
                <span class="circle circle5">
                    <img src="${'http://127.0.0.1:7000/media/chatbot_logos/calmove.PNG' || '#'}" alt="Chatbot Logo" height="35">
                </span>
  ...
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
            ...
            <div id="chat-page" class="page active">
                ...
                <div class="quick-access-buttons">
                    <button class="quick-access-button" onclick="sendButtonValue('click')">Button 1</button>
                    <div>
                    <button class="quick-access-button" onclick="sendButtonValue('click')">Button 2</button>
                    <button class="quick-access-button" onclick="sendButtonValue('click')">Button 3</button>
                    </div>
                    <button class="quick-access-button" onclick="sendButtonValue('click')">Button 4</button>
                    <button class="quick-access-button" onclick="sendButtonValue('click')">Button 5</button>
                </div>
  ...
  <path d="M5.933.87a2.89 2.89 0 0 1 4.134 0l.622.638.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.636a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.011a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01zM7.002 11a1 1 0 1 0 2 0 1 1 0 0 0-2 0m1.602-2.027c.04-.534.198-.815.846-1.26.674-.475 1.05-1.09 1.05-1.986 0-1.325-.92-2.227-2.262-2.227-1.02 0-1.792.492-2.1 1.29A1.7 1.7 0 0 0 6 5.48c0 .393.203.64.545.64.272 0 .455-.147.564-.51.158-.592.525-.915 1.074-.915.61 0 1.03.446 1.03 1.084 0 .563-.208.885-.822 1.325-.619.433-.926.914-.926 1.64v.111c0 .428.208.745.585.745.336 0 .504-.24.554-.627"/>
    ...
    function toggleChat() {
        ...
        if (chatWidget.style.display === 'none' || chatWidget.style.display === '') {
            ...
            fetch('http://127.0.0.1:7000/chat/response/9/', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    session_id: null,
                    is_new_session: true,
                    logo_url: 'http://127.0.0.1:7000/media/chatbot_logos/calmove.PNG'
                })
            })
    ...
    async function appendMessage(content, className) {
        ...
        if (className === 'bot-message' && isFirstMessage) {
            ...
            messageDiv.innerHTML = `
                <h3>Welcome! How may I help you?</h3>
                <div class="quick-access-buttons">
                    <button class="quick-access-button" onclick="sendButtonValue('Product Information')">Product Information</button>
                    <div>
                        <button class="quick-access-button" onclick="sendButtonValue('Order Status')">Order Status</button>
                        <button class="quick-access-button" onclick="sendButtonValue('Customer Support')">Support</button>
                    </div>
                    <button class="quick-access-button" onclick="sendButtonValue('Track Order')">Track Order</button>
                    <button class="quick-access-button" onclick="sendButtonValue('Contact Us')">Contact Us</button>
                </div>
                <div class="timestamp">${getCurrentTime()}</div>
            `;
...
<div id="load">
  ...
  <div>L</div>
    ...
    function saveLead() {
        ...
        const chatResponseUrl = 'http://127.0.0.1:7000/chat/response/9/';
