(function() {
    ...
    function initChatWidget() {
        ...
        weAreHereImage.src = 'http://127.0.0.1:7000/media/chatbot_we_are_here/userlmn_2a8d8a2ca1de8e3d3002e115e4ab432d_1.png' || '#';
        ...
        chatWidget.innerHTML = `
            <div id="chat-header">
                <div class="header-text-container">
                    <img id="chat-logo" src="${'http://127.0.0.1:7000/media/chatbot_logos/pk.PNG' || '#'}" alt="Chatbot Logo">
    ...
    function toggleChat() {
        ...
        if (chatWidget.style.display === 'none' || chatWidget.style.display === '') {
            ...
            fetch('http://127.0.0.1:7000/chat/response/7/', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    session_id: null,
                    is_new_session: true,
                    logo_url: 'http://127.0.0.1:7000/media/chatbot_logos/pk.PNG'
                })
            })
