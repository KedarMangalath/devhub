...
#chat-widget .bot-message:before {
    ...
    bottom: 0;
    left: 0;
        background: linear-gradient(-45deg, #086625 0%, #086625 100%);
...
#chat-widget .bot-message::after {
    ...
    z-index: 10;
        ...
        #chat-button:before {
            ...
            bottom: 0;
            left: 0;
            background: linear-gradient(-45deg, #086625 0%, #ffffff 100%);
...
.quick-link:hover:before {
  top: -70%;
  background-image: radial-gradient(circle, #086625; 20%, transparent 20%),
    radial-gradient(circle, transparent 20%, #086625; 20%, transparent 30%),
    radial-gradient(circle, #086625; 20%, transparent 20%),
    radial-gradient(circle, #086625; 20%, transparent 20%),
    radial-gradient(circle, transparent 10%, #086625; 15%, transparent 20%),
    radial-gradient(circle, #086625; 20%, transparent 20%),
    radial-gradient(circle, #086625; 20%, transparent 20%),
    radial-gradient(circle, #086625; 20%, transparent 20%),
    radial-gradient(circle, #086625; 20%, transparent 20%);
...
width:100%;
  height: 100%;
  border-radius: 55px;
  background: linear-gradient(135deg, #086625, #086625);
        ...
        chatWidget.innerHTML = `
            <div id="chat-header">
                <div class="header-text-container">
                    <img id="chat-logo" src="${'https://127.0.0.1:7000/media/chatbot_logos/tc.PNG' || '#'}" alt="Chatbot Logo">
                        ...
                        <div class="card">
                            <div class="logo">
                                ...
                                <span class="circle circle5">
                                    <img src="${'https://127.0.0.1:7000/media/chatbot_logos/tc.PNG' || '#'}" alt="Chatbot Logo" height="35">
                                </span>
                            </div>
                            <div class="glass"></div>
                            <div class="content">
                                <span class="title">TECHNOCORP</span>
            ...
            <div id="chat-footer">
                <ul class="footer-button">
                    <li style="--i:#086625;--j:#086625;" onclick="window.navigateToPage('home')">
                ...
                <ul class="footer-button">
                    <li style="--i:#086625;--j:#086625;" onclick="window.navigateToPage('chat')">
                ...
                <ul class="footer-button">
                    <li style="--i:#086625;--j:#086625;" onclick="window.navigateToPage('help')">
    ...
    function toggleChat() {
        ...
        if (chatWidget.style.display === 'none' || chatWidget.style.display === '') {
            ...
            if (activeFlow && activeFlow.steps && activeFlow.steps.length > 0) {
                ...
                appendMessage("Welcome to TECHNOCORP !  how can i help you?", 'bot-message');
            ...
            fetch('https://127.0.0.1:7000/chat/response/5/', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    logo_url: 'https://127.0.0.1:7000/media/chatbot_logos/tc.PNG'
                })
            })
...
function createLeadForm(type) {
    ...
    form.style.border = `2px solid #086625`;
    form.style.borderRadius = "10px";

    if (type === 'name') {
        form.innerHTML = `
            <input type="text" class="lead-input" placeholder="Enter your name" style="width: 100%; padding: 8px; margin-bottom: 10px; border: 1px solid #086625; border-radius: 5px;">
            <button class="lead-submit-btn" style="background-color: #086625; color: white; padding: 8px 16px; border: none; border-radius: 5px; cursor: pointer;">Submit</button>
        `;
        ...
        form.innerHTML = `
            <input type="tel" class="lead-input" placeholder="Enter your 10-digit phone number" style="width: 100%; padding: 8px; margin-bottom: 10px; border: 1px solid #086625; border-radius: 5px;">
            <button class="lead-submit-btn" style="background-color: #086625; color: white; padding: 8px 16px; border: none; border-radius: 5px; cursor: pointer;">Submit</button>
        `;
...
function saveLead() {
    ...
    const chatResponseUrl = 'https://127.0.0.1:7000/chat/response/5/';
