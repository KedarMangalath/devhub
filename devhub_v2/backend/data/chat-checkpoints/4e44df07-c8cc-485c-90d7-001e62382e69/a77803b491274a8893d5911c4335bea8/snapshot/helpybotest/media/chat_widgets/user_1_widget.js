...
.bot-message:before {
    ...
    bottom: 0;
    left: 0;
        background: linear-gradient(-45deg, #0b3d2c 0%, #0b3d2c 100%);
...
.bot-message::after {
    ...
    z-index: 10;
        ...
        #chat-button:before {
            ...
            bottom: 0;
            left: 0;
            background: linear-gradient(-45deg, #0b3d2c 0%, #ffffff 100%);
...
.quick-link:hover:before {
  top: -70%;
  background-image: radial-gradient(circle, #0b3d2c; 20%, transparent 20%),
    radial-gradient(circle, transparent 20%, #0b3d2c; 20%, transparent 30%),
    radial-gradient(circle, #0b3d2c; 20%, transparent 20%),
    radial-gradient(circle, #0b3d2c; 20%, transparent 20%),
    radial-gradient(circle, transparent 10%, #0b3d2c; 15%, transparent 20%),
    radial-gradient(circle, #0b3d2c; 20%, transparent 20%),
    radial-gradient(circle, #0b3d2c; 20%, transparent 20%),
    radial-gradient(circle, #0b3d2c; 20%, transparent 20%),
    radial-gradient(circle, #0b3d2c; 20%, transparent 20%);
...
width:100%;
  height: 100%;
  border-radius: 55px;
  background: linear-gradient(135deg, #0b3d2c, #0b3d2c);
...
.send-button:disabled {
        ...
        chatWidget.innerHTML = `
            ...
            <div id="chat-footer">
                <ul class="footer-button">
                    <li style="--i:#0b3d2c;--j:#0b3d2c;" onclick="window.navigateToPage('home')">
                ...
                <ul class="footer-button">
                    <li style="--i:#0b3d2c;--j:#0b3d2c;" onclick="window.navigateToPage('chat')">
                ...
                <ul class="footer-button">
                    <li style="--i:#0b3d2c;--j:#0b3d2c;" onclick="window.navigateToPage('help')">
    ...
    function toggleChat() {
        ...
        if (chatWidget.style.display === 'none' || chatWidget.style.display === '') {
            ...
            fetch('https://127.0.0.1:8317/chat/response/1/', {
                method: 'POST',
                headers: {
...
function createLeadForm(type) {
    ...
    form.style.border = `2px solid #0b3d2c`;
    form.style.borderRadius = "10px";

    if (type === 'name') {
        form.innerHTML = `
            <input type="text" class="lead-input" placeholder="Enter your name" style="width: 100%; padding: 8px; margin-bottom: 10px; border: 1px solid #0b3d2c; border-radius: 5px;">
            <button class="lead-submit-btn" style="background-color: #0b3d2c; color: white; padding: 8px 16px; border: none; border-radius: 5px; cursor: pointer;">Submit</button>
        `;
        ...
        form.innerHTML = `
            <input type="tel" class="lead-input" placeholder="Enter your 10-digit phone number" style="width: 100%; padding: 8px; margin-bottom: 10px; border: 1px solid #0b3d2c; border-radius: 5px;">
            <button class="lead-submit-btn" style="background-color: #0b3d2c; color: white; padding: 8px 16px; border: none; border-radius: 5px; cursor: pointer;">Submit</button>
        `;
...
function saveLead() {
    ...
    const chatResponseUrl = 'https://127.0.0.1:8317/chat/response/1/';
