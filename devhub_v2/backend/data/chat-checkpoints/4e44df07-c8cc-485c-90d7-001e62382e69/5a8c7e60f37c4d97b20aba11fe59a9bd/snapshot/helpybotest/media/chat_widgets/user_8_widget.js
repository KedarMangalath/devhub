(function() {
    ...
    Promise.all(resources.map(loadResource))
        ...
        function initChatWidget() {
            ...
            // Check if chat toggle image URL exists
            const chatToggleUrl = '';
            if (chatToggleUrl && chatToggleUrl !== '#') {
                // Create an image element for the custom toggle button
            ...
            chatWidget.innerHTML = `
                ...
                <div id="chat-messages">
                    ...
                    <div class="message bot-message">
                        <p data-original-text="Welcome! How may I help you?">Welcome! How may I help you?</p>
    ...
    function toggleChat() {
        ...
        if (chatWidget.style.display === 'none' || chatWidget.style.display === '') {
            ...
            fetch('http://127.0.0.1:7000/chat/response/8/', {
                method: 'POST',
                headers: {
    ...
    function sendMessage() {
        ...
        if (userMessageCount === 3 && !leadState.nameCollected && leadsEnabled) { // Change from 1 to 2
    ...
    function formatMessage(message, isBot) {
        if (isBot) {
            // Extract image URLs from markdown syntax and replace them with <img> tags
            message = message.replace(/!\[.*?\]\((.*?)\)/g, function(match, src) {
    ...
    function saveLead() {
        ...
        const chatResponseUrl = 'http://127.0.0.1:7000/chat/response/8/';
