...
.bot-message:before {
    ...
    bottom: 0;
    left: 0;
        background: linear-gradient(-45deg, #78b09d 0%, #78b09d 100%);
...
.bot-message::after {
    ...
    z-index: 10;
        ...
        #chat-button:before {
            ...
            bottom: 0;
            left: 0;
            background: linear-gradient(-45deg, #78b09d 0%, #ffffff 100%);
...
.quick-link:hover:before {
  top: -70%;
  background-image: radial-gradient(circle, #78b09d; 20%, transparent 20%),
    radial-gradient(circle, transparent 20%, #78b09d; 20%, transparent 30%),
    radial-gradient(circle, #78b09d; 20%, transparent 20%),
    radial-gradient(circle, #78b09d; 20%, transparent 20%),
    radial-gradient(circle, transparent 10%, #78b09d; 15%, transparent 20%),
    radial-gradient(circle, #78b09d; 20%, transparent 20%),
    radial-gradient(circle, #78b09d; 20%, transparent 20%),
    radial-gradient(circle, #78b09d; 20%, transparent 20%),
    radial-gradient(circle, #78b09d; 20%, transparent 20%);
...
width:100%;
  height: 100%;
  border-radius: 55px;
  background: linear-gradient(135deg, #78b09d, #78b09d);
...
.send-button:disabled {
        ...
        chatWidget.innerHTML = `
            <div id="chat-header">
                <div class="header-text-container">
                    <img id="chat-logo" src="${'http://127.0.0.1:8000/media/chatbot_logos/Screenshot_2024-12-30_142643.png' || '#'}" alt="Chatbot Logo">
                        ...
                        <div class="card">
                            <div class="logo">
                                ...
                                <span class="circle circle5">
                                    <img src="${'http://127.0.0.1:8000/media/chatbot_logos/Screenshot_2024-12-30_142643.png' || '#'}" alt="Chatbot Logo" height="35">
                                </span>
                            </div>
                            <div class="glass"></div>
                            <div class="content">
            ...
            <div id="chat-footer">
                <ul class="footer-button">
                    <li style="--i:#78b09d;--j:#78b09d;" onclick="window.navigateToPage('home')">
                ...
                <ul class="footer-button">
                    <li style="--i:#78b09d;--j:#78b09d;" onclick="window.navigateToPage('chat')">
                ...
                <ul class="footer-button">
                    <li style="--i:#78b09d;--j:#78b09d;" onclick="window.navigateToPage('help')">
    ...
    function toggleChat() {
        ...
        if (chatWidget.style.display === 'none' || chatWidget.style.display === '') {
            ...
            fetch('http://127.0.0.1:8000/chat/response/11/', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    logo_url: 'http://127.0.0.1:8000/media/chatbot_logos/Screenshot_2024-12-30_142643.png'
                })
            })
...
function createLeadForm(type) {
    ...
    form.style.border = `2px solid #78b09d`;
    form.style.borderRadius = "10px";

    if (type === 'name') {
        form.innerHTML = `
            <input type="text" class="lead-input" placeholder="Enter your name" style="width: 100%; padding: 8px; margin-bottom: 10px; border: 1px solid #78b09d; border-radius: 5px;">
            <button class="lead-submit-btn" style="background-color: #78b09d; color: white; padding: 8px 16px; border: none; border-radius: 5px; cursor: pointer;">Submit</button>
        `;
        ...
        form.innerHTML = `
            <input type="tel" class="lead-input" placeholder="Enter your 10-digit phone number" style="width: 100%; padding: 8px; margin-bottom: 10px; border: 1px solid #78b09d; border-radius: 5px;">
            <button class="lead-submit-btn" style="background-color: #78b09d; color: white; padding: 8px 16px; border: none; border-radius: 5px; cursor: pointer;">Submit</button>
        `;
...
function saveLead() {
    ...
    const chatResponseUrl = 'http://127.0.0.1:8000/chat/response/11/';
