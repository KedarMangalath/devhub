        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group flex items-center gap-2 px-6 py-4 text-sm font-medium transition-all duration-200 whitespace-nowrap border-b-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#1d4ed8] focus-visible:ring-inset",
                isActive
              ...
              {Icon && (
                <Icon 
                  className={cn(
                    ...
                    isActive ? "text-[#1d4ed8]" : "text-slate-400 group-hover:text-slate-600",
