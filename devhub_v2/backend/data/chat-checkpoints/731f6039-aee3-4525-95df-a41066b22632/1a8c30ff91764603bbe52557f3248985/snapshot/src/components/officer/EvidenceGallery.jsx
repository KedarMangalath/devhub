          ...
          >
            ...
            <div className="h-44 bg-slate-50 relative border-b border-slate-100 flex items-center justify-center overflow-hidden">
              ...
              <div className="absolute inset-0 bg-slate-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center gap-3 backdrop-blur-[2px]">
                <button
                  type="button"
                  className="p-2.5 bg-white text-slate-900 rounded-full hover:bg-slate-50 hover:text-[#1d4ed8] transition-colors shadow-sm transform translate-y-2 group-hover:translate-y-0 duration-200"
                  title="Download"
                >
            ...
            <div className="p-4 flex flex-col flex-1 justify-between bg-white">
              ...
              <button
                type="button"
                className="w-full py-2 px-3 text-sm font-medium text-[#1d4ed8] bg-[#1d4ed8]/5 hover:bg-[#1d4ed8]/10 border border-[#1d4ed8]/10 rounded-lg transition-colors flex items-center justify-center gap-2"
              >
                View File
              </button>
            </div>
