        ...
        <div className="space-y-6">
          ...
          {complaint.status === 'Resolved' && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start">
              ...
              <div>
                <h4 className="font-medium text-blue-900">Resolution Acknowledgment</h4>
                <p className="text-sm text-blue-800 mt-1">This complaint has been marked as resolved. If you are not satisfied with the outcome, you have 7 days to raise a dispute.</p>
                <button className="mt-3 bg-white border border-blue-300 text-blue-700 px-3 py-1.5 rounded text-sm font-medium hover:bg-blue-50">
                  Raise Dispute
                </button>
              </div>
            </div>
