        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0F172A] tracking-tight leading-[1.15] mb-6">
              Report Corruption <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1d4ed8] to-blue-500">Fearlessly.</span>
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/file-complaint"
                className="inline-flex justify-center items-center px-6 py-3.5 border border-transparent text-base font-medium rounded-lg text-white bg-[#1d4ed8] hover:bg-blue-800 shadow-sm hover:shadow-md transition-all duration-200 group"
              >
                File a Complaint
