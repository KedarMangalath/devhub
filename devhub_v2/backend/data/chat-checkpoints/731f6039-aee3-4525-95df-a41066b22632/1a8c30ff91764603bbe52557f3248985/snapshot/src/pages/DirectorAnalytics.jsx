...
export default function DirectorAnalytics() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans text-[#0F172A] selection:bg-[#1d4ed8]/20 selection:text-[#1d4ed8]">
      <Navbar />
                  ...
                  return (
                    <div key={i} className="flex flex-col items-center gap-2 w-full group h-full justify-end">
                      <div className="w-full relative flex items-end justify-center h-full">
                        <div
                          className="w-3/4 sm:w-4/5 bg-[#1d4ed8]/80 group-hover:bg-[#1d4ed8] transition-all duration-300 rounded-t-sm relative"
