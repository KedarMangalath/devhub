  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          type="text"
          className="block w-full pl-10 pr-3 py-3.5 border border-slate-200 rounded-xl leading-5 bg-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 sm:text-sm transition-colors shadow-sm"
      ...
      {filteredDepartments.length > 0 ? (
          ...
          {filteredDepartments.map((dept) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex flex-col items-start p-5 rounded-xl border text-left transition-all duration-200 w-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2",
                  isSelected
        ...
        <div className="text-center py-16 bg-slate-50 rounded-xl border border-slate-200 border-dashed">
          ...
          <button
            ...
            className="mt-6 text-sm font-medium text-blue-600 hover:text-blue-700 bg-blue-50 px-4 py-2 rounded-lg transition-colors"
          >
            Clear search
          </button>
        </div>
