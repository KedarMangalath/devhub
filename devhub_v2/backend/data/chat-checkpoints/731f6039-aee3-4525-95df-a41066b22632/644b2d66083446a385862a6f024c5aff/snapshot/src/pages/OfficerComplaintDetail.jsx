    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-[#0F172A]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <Link 
            to="/officer" 
            className="inline-flex items-center text-sm font-medium text-slate-500 hover:text-[#047857] transition-colors mb-4 focus:outline-none focus:ring-2 focus:ring-[#047857] focus:ring-offset-2 rounded-md px-1 -ml-1"
          >
            ...
            <section className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                ...
                <textarea
                  id="notes"
                  rows={4}
                  className="w-full rounded-lg border border-slate-300 px-4 py-3 text-sm focus:border-[#047857] focus:ring-1 focus:ring-[#047857] outline-none transition-shadow resize-y"
                ...
                <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="flex items-center h-6">
                    {showSuccess && (
                      <span className="flex items-center text-sm font-medium text-[#047857] animate-in fade-in slide-in-from-bottom-2">
                  ...
                  <div className="flex items-center gap-3 w-full sm:w-auto">
                    ...
                    <button
                      ...
                      className="flex-1 sm:flex-none inline-flex items-center justify-center px-5 py-2.5 bg-[#047857] text-white text-sm font-semibold rounded-lg hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#047857] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSaving ? (
