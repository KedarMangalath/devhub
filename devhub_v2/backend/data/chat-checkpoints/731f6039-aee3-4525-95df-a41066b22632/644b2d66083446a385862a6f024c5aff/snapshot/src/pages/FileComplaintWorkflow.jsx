          ...
          {step === 5 && (
            <div className="flex flex-col items-center justify-center text-center py-16 animate-in fade-in zoom-in duration-500 my-auto">
              <div className="w-24 h-24 bg-blue-50 rounded-full flex items-center justify-center mb-6 ring-8 ring-blue-50/50">
                <CheckCircle className="w-12 h-12 text-[#047857]" strokeWidth={2.5} />
              </div>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-8 w-full max-w-md mb-10 shadow-sm">
                ...
                <div className="bg-white border border-slate-200 py-4 px-6 rounded-lg inline-block">
                  <p className="text-3xl font-mono font-bold text-[#047857] tracking-widest">{trackingId}</p>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
                <Link 
                  to="/track" 
                  className="flex-1 inline-flex justify-center items-center px-6 py-3.5 bg-[#047857] text-white font-medium rounded-lg hover:bg-blue-800 transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#047857]"
                >
                  Track Status Now
                </Link>
                <Link 
            ...
            {step < 4 ? (
              <button
                ...
                className={`px-8 py-2.5 rounded-lg font-medium transition-all duration-200 shadow-sm ${
                  canProceed()
                    ? 'bg-[#047857] text-white hover:bg-blue-800 focus:ring-2 focus:ring-offset-2 focus:ring-[#047857]'
              ...
              <button
                ...
                className="px-8 py-2.5 rounded-lg font-medium transition-all duration-200 shadow-sm bg-[#047857] text-white hover:bg-blue-800 focus:ring-2 focus:ring-offset-2 focus:ring-[#047857]"
              >
                Submit Complaint
              </button>
            )}
