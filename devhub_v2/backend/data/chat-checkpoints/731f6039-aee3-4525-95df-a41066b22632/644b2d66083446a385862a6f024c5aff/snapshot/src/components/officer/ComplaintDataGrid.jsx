            ...
            {complaints.map((complaint) => (
              ...
              >
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  <span className="font-mono text-slate-500 group-hover:text-blue-700 transition-colors">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  {complaint.sla_status === 'Warning' ? (
                    ...
                    <div className="flex items-center text-blue-600 font-medium px-2.5 py-1">
