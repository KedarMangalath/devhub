...
export default function AppShell() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC] font-sans text-[#0F172A] selection:bg-[#047857]/20 selection:text-[#047857]">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/90 backdrop-blur-md shadow-sm">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            {/* Logo & Brand */}
            <Link to="/" className="flex items-center gap-2.5 group focus:outline-none focus:ring-2 focus:ring-[#047857] focus:ring-offset-2 rounded-lg p-1 -ml-1">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#047857] text-white shadow-sm group-hover:bg-[#047857]/90 transition-colors">
            ...
            <div className="hidden md:flex items-center gap-4">
              <button 
                className="relative p-2 text-slate-400 hover:text-slate-600 transition-colors rounded-full hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-[#047857]"
              ...
              <Link
                to="/file-complaint"
                className="ml-2 inline-flex items-center justify-center gap-2 rounded-lg bg-[#047857] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-[#047857]/90 hover:shadow focus:outline-none focus:ring-2 focus:ring-[#047857] focus:ring-offset-2"
              >
            ...
            <div className="flex items-center gap-3 md:hidden">
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-md p-2 text-slate-500 hover:bg-slate-100 hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#047857]"
          ...
          <div className="md:hidden border-t border-slate-200 bg-white shadow-xl absolute w-full left-0">
            ...
            <div className="border-t border-slate-100 pb-5 pt-4 bg-slate-50/50">
              ...
              <div className="px-4">
                <Link
                  to="/file-complaint"
                  className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#047857] px-4 py-3 text-base font-semibold text-white shadow-sm hover:bg-[#047857]/90 transition-colors focus:outline-none focus:ring-2 focus:ring-[#047857] focus:ring-offset-2"
                >
