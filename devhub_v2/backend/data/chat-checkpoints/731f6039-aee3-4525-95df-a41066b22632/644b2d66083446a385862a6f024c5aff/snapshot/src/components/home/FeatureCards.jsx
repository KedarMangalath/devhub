        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div 
                key={index} 
                className="bg-white border border-slate-200 rounded-lg p-8 shadow-sm hover:shadow-md hover:border-blue-200 hover:-translate-y-1 transition-all duration-300 flex flex-col items-start group"
              >
                <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-blue-50 text-blue-700 mb-6 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
