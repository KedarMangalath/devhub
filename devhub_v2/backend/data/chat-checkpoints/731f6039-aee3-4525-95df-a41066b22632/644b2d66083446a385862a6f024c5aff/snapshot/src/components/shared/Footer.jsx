        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[#64748B]">
              ...
              <li>
                <a href="#" className="hover:text-[#047857] transition-colors">Citizen Charter</a>
              </li>
              <li>
                <a href="#" className="hover:text-[#047857] transition-colors">Whistleblower Protection Act</a>
              </li>
            </ul>
          </div>
        </div>
