        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Shield className="h-6 w-6 text-vacb-700" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[#64748B]">
              <li>
                <a href="#" className="hover:text-vacb-700 transition-colors">Privacy Policy</a>
              </li>
              <li>
                <a href="#" className="hover:text-vacb-700 transition-colors">Terms of Service</a>
              </li>
              <li>
                <a href="#" className="hover:text-vacb-700 transition-colors">Citizen Charter</a>
              </li>
              <li>
                <a href="#" className="hover:text-vacb-700 transition-colors">Whistleblower Protection Act</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="flex gap-4 text-sm text-[#64748B]">
            <span className="flex items-center gap-1.5">
              <span className="relative flex h-2.5 w-2.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-vacb-700 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-vacb-700"></span>
              </span>
