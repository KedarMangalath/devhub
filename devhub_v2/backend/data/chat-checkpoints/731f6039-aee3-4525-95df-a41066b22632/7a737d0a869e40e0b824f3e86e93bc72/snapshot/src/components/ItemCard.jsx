  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-grow p-5">
        ...
        <div className="mb-3">
          {subtitle && (
            <div className="flex items-center gap-1.5 text-xs font-medium text-vacb-700 mb-1.5 uppercase tracking-wider">
              <Tag className="w-3.5 h-3.5" />
              {subtitle}
            </div>
          )}
          <h3 className="text-lg font-bold text-slate-900 line-clamp-2 leading-tight group-hover:text-vacb-800 transition-colors">
            {title}
          </h3>
        </div>
        ...
        <div className="mt-auto pt-4 flex items-center justify-between border-t border-slate-100">
          ...
          {onAction && (
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-4 py-2 text-sm font-medium text-vacb-700 bg-vacb-50 hover:bg-vacb-100 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-vacb-500 focus:ring-offset-1"
            >
              {actionLabel}
