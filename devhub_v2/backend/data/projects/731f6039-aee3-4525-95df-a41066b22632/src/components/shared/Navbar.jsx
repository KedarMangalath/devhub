      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link 
              to="/" 
              className="flex items-center gap-2.5 group focus:outline-none focus:ring-2 focus:ring-vacb-700 focus:ring-offset-2 rounded-md"
            >
              <div className="bg-vacb-700 p-1.5 rounded-lg group-hover:bg-vacb-800 transition-colors">
          ...
          <div className="flex items-center md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-slate-500 hover:text-slate-900 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-vacb-700"
              aria-expanded="false"
            >
