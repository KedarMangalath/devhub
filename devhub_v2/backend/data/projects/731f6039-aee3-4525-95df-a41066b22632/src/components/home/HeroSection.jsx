...
export default function HeroSection() {
  return (
    <section className="relative bg-[#F8FAFC] pt-16 pb-20 lg:pt-24 lg:pb-28 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-vacb-50 rounded-bl-full opacity-50 blur-3xl pointer-events-none transform translate-x-1/3 -translate-y-1/4"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="max-w-2xl">
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-vacb-100/80 text-vacb-800 text-sm font-semibold tracking-wide mb-6 border border-vacb-200">
              <span className="flex h-2 w-2 rounded-full bg-vacb-600 mr-2 animate-pulse"></span>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0F172A] tracking-tight leading-[1.15] mb-6">
              Report Corruption <span className="text-transparent bg-clip-text bg-gradient-to-r from-vacb-700 to-vacb-500">Fearlessly.</span>
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/file-complaint"
                className="inline-flex justify-center items-center px-6 py-3.5 border border-transparent text-base font-medium rounded-lg text-white bg-vacb-700 hover:bg-vacb-800 shadow-sm hover:shadow-md transition-all duration-200 group"
              >
                File a Complaint
            ...
            <div className="mt-10 flex items-center gap-6 text-sm text-slate-500 font-medium">
              <div className="flex items-center gap-2">
                <svg className="h-5 w-5 text-vacb-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          ...
          <div className="relative lg:ml-auto w-full max-w-lg lg:max-w-none">
            ...
            <div className="absolute -inset-4 border-2 border-vacb-100 rounded-2xl transform translate-x-3 translate-y-3 -z-10 hidden sm:block"></div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-white aspect-[4/3] sm:aspect-[16/10] lg:aspect-[4/5] xl:aspect-[3/4]">
              ...
              <div className="absolute bottom-6 left-6 right-6 sm:right-auto bg-white/95 backdrop-blur-sm p-4 rounded-xl shadow-lg border border-white/20">
                <div className="flex items-center gap-4">
                  <div className="flex-shrink-0 bg-vacb-100 p-2.5 rounded-lg">
                    <svg className="h-6 w-6 text-vacb-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
