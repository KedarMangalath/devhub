  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      <div className="px-6 py-5 border-b border-slate-200 bg-slate-50/50 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 bg-vacb-700/10 text-vacb-700 rounded-full text-xs font-medium">
          <span className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-vacb-700 opacity-75"></span>
            <span className="relative inline-flex rounded-full h-2 w-2 bg-vacb-700"></span>
          </span>
          Network Synced
        </div>
      </div>
            ...
            return (
              <div key={event.id} className="relative pl-8 group">
                ...
                <div className={`absolute -left-[9px] top-1.5 h-4 w-4 rounded-full border-2 bg-white transition-colors duration-200 ${
                  isLatest 
                    ? 'border-vacb-700 shadow-[0_0_0_4px_rgba(4,120,87,0.1)]' 
                    : 'border-slate-300 group-hover:border-vacb-700'
                }`} />
                ...
                <div className="flex flex-col gap-2.5">
                  ...
                  <div className="mt-1 inline-flex items-center gap-2 px-2.5 py-1.5 rounded-md bg-slate-50 border border-slate-200 w-fit group-hover:bg-white group-hover:border-slate-300 transition-colors">
                    <LinkIcon className="w-3.5 h-3.5 text-vacb-700" />
