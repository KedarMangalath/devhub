              ...
              <div className="relative flex flex-col items-center">
                <div
                  className={cn(
                    ...
                    isCompleted && "bg-vacb-700 border-vacb-700 text-white",
                    isActive && "border-vacb-700 text-vacb-700 ring-4 ring-vacb-50",
              ...
              {index < steps.length - 1 && (
                <div
                  className={cn(
                    ...
                    index < currentStep ? "bg-vacb-700" : "bg-slate-200"
                  )}
                />
              )}
            </div>
