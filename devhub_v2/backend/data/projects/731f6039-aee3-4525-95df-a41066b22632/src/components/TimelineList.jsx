...
const getIconForAction = (action) => {
  ...
  if (lower.includes('filed') || lower.includes('submitted')) {
    return <FileText className="w-4 h-4 text-vacb-600" />;
  }
  ...
  if (lower.includes('verif') || lower.includes('approv') || lower.includes('resolv')) {
    return <ShieldCheck className="w-4 h-4 text-vacb-600" />;
  }
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-600">
                      ...
                      {event.blockchain_hash && (
                        <>
                          ...
                          <span className="inline-flex items-center gap-1 text-vacb-700 bg-vacb-50 px-1.5 py-0.5 rounded font-mono text-[10px] border border-vacb-100">
